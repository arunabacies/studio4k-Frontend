...
<?php use App\Http\Controllers\StudioController; $StudioController= new StudioController(); ?>
    ...
    <section id="content-types" class="project_list">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    @if (Session::get('role') == 1 ) 
                        <button class="btn btn-warning" data-toggle="modal" 
                            data-target="#addStudioModal">
                            <i class="bx bx-plus-circle">&nbsp;</i>New Studio
                        </button>
                    @endif
                </div>
                <hr/>
                    ...
                    <div class="card">
                            ...
                            @if (Session::get('role') == 1) 
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" 
                                        ...
                                        <a class="dropdown-item studioEdit" href="javascript:void(0);" 
                                            data-toggle="modal" data-target="#editStudioModal" 
                                            data-id="{{ $project->id }}" 
                        ...
                        <div class="card-body">
                            <div class="d-flex mb-2" style="flex-wrap: wrap;">
                                <p class="w-50 mb-50 title">STUDIO MANAGER:</p>
                            ...
                            <div class="d-flex justify-content-between text-center">
                                ...
                                <p class="m-0">Sessions<small class="d-block">{{ $project->sessions}}</small></p>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-center mb-50">
                            <a class="btn btn-danger" href="{{route('view-studio', $project->id)}}">Go</a>
                        </div>
                    </div>
                </div>
        ...
        @if($data)
                ...
                <div class="pagination">
                    ...
                    {!!$StudioController->paginate_with_custom_path($data)!!}
                  </div>
